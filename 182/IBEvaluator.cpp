...
class IBEvaluator {
public:
	vector <int> getSummary(vector <int>, vector <int>);
};

vector <int> IBEvaluator::getSummary(vector <int> p, vector <int> a) {
	vector<int> v;
...
double test0() {
	...
	IBEvaluator * obj = new IBEvaluator();
	clock_t start = clock();
	vector <int> my_answer = obj->getSummary(p0, p1);
	clock_t end = clock();
	delete obj;
